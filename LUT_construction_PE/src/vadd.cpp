...
void load_center_vectors(
    ...
    hls::stream<struct_16_float_t>& s_center_vectors) {
    ...
    struct_16_float_t packed_center_vectors[8];
    for (int i = 0; i < 8; i++) {
        packed_center_vectors[i].val_0 = center_vector_buffer[i * 16 + 0];
        packed_center_vectors[i].val_1 = center_vector_buffer[i * 16 + 1];
        packed_center_vectors[i].val_2 = center_vector_buffer[i * 16 + 2];
        packed_center_vectors[i].val_3 = center_vector_buffer[i * 16 + 3];
        packed_center_vectors[i].val_4 = center_vector_buffer[i * 16 + 4];
        packed_center_vectors[i].val_5 = center_vector_buffer[i * 16 + 5];
        packed_center_vectors[i].val_6 = center_vector_buffer[i * 16 + 6];
        packed_center_vectors[i].val_7 = center_vector_buffer[i * 16 + 7];
        packed_center_vectors[i].val_8 = center_vector_buffer[i * 16 + 8];
        packed_center_vectors[i].val_9 = center_vector_buffer[i * 16 + 9];
        packed_center_vectors[i].val_10 = center_vector_buffer[i * 16 + 10];
        packed_center_vectors[i].val_11 = center_vector_buffer[i * 16 + 11];
        packed_center_vectors[i].val_12 = center_vector_buffer[i * 16 + 12];
        packed_center_vectors[i].val_13 = center_vector_buffer[i * 16 + 13];
        packed_center_vectors[i].val_14 = center_vector_buffer[i * 16 + 14];
        packed_center_vectors[i].val_15 = center_vector_buffer[i * 16 + 15];
    }
    ...
    for (int query_id = 0; query_id < query_num; query_id++) {
        ...
        for (int nprobe_id = 0; nprobe_id < NPROBE; nprobe_id++) {
            ...
            for (int i = 0; i < 8; i++) {
#pragma HLS pipeline II=1
                s_center_vectors.write(packed_center_vectors[i]);
            }
        }
    }
}
