...
int main(int argc, char** argv)
{
    ...
    // linear scan a 1-million-vec dataset
    ...
    size_t PQ_codes_DRAM_0_bytes = nlist * entries_num * 64;
    size_t PQ_codes_DRAM_1_bytes = nlist * entries_num * 64;
    size_t PQ_codes_DRAM_2_bytes = nlist * entries_num * 64;
    size_t PQ_codes_DRAM_3_bytes = nlist * entries_num * 64;
